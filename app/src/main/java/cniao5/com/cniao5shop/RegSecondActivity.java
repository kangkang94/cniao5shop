...
public class RegSecondActivity extends BaseActivity {
    ...
    private void doReg(){
        ...
        okHttpHelper.post(Constants.API.REG, params, new SpotsCallBack<LoginRespMsg<User>>(this) {
            ...
            public void onTokenError(Response response, int code) {
                ...
                ToastUtils.show(RegSecondActivity.this,"注册失败，请重新注册");
                Intent intent = new Intent(RegSecondActivity.this,RegActivity.class);
                RegSecondActivity.this.startActivity(intent);
